//
//  CheckMarkButtonToggleBlack.swift
//  FocusOn
//
...
class CheckMarkToggleButtonBlack: UIButton {
    
    let impactGenerator = UIImpactFeedbackGenerator()
    let tick = UIImage(named: "tick-black")
    ...
    func initButton() {
        ...
        let colouredTick = tick!.withTintColor(midnightBlue!)
        
        setImage(untick, for: .normal)
        
        setImage(colouredTick, for: .selected)
    }
